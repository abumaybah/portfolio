    ...
    function p(e) {
        ...
        if (E.generated || R.generated.initial) {
            ...
            var P = i.delay,
                L = i.duration,
                M = i.easing;
            E.generated && A.fragments.push({ delayed: 'opacity ' + L / 1e3 + 's ' + M + ' ' + P / 1e3 + 's', instant: 'opacity ' + L / 1e3 + 's ' + M + ' 0s' }), R.generated.initial && A.fragments.push({ delayed: R.property + ' ' + L / 1e3 + 's ' + M + ' ' + P / 1e3 + 's', instant: R.property + ' ' + L / 1e3 + 's ' + M + ' 0s' }), A.computed && !A.computed.match(/all 0s|none 0s/) && A.fragments.unshift({ delayed: A.computed, instant: A.computed });
